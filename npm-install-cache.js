...
function useCacheFolder(fileToCheck, localFolderToCache, getPackagesCommand) {
    fs.readFile(fileToCheck, function (err, data) {
        ...
        function notFoundCallback(searchDir) {
            ...
            //Run npm install
            var npm_install = spawn('powershell', [getPackagesCommand]);
            ...
            npm_install.stdout.on('end', function() {
                ...
                var move = spawn('powershell', ['mv ' + localFolderToCache, searchDir]);
        ...
        function createSymbolicLinkToNodeModules(searchDir, folderContent) {
            ...
            var destPath = __dirname + '\\' + localFolderToCache;
...
useCacheFolder('package.json', 'node_modules', 'npm install');